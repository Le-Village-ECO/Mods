...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronHoeRecipe : RecipeFamily
    {
        public IronHoeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronHoeRecipe), start: 0.5f, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));
