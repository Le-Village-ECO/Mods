...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernMacheteRecipe : RecipeFamily
    {
        public ModernMacheteRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernMacheteRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
