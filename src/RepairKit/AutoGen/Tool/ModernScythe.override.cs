...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernScytheRecipe : RecipeFamily
    {
        public ModernScytheRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernScytheRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
