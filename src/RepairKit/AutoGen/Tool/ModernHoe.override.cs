...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernHoeRecipe : RecipeFamily
    {
        public ModernHoeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernHoeRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
