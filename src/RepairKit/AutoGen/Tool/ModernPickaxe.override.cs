...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernPickaxeRecipe : RecipeFamily
    {
        public ModernPickaxeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernPickaxeRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
