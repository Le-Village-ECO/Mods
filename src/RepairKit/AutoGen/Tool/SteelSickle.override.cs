...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelSickleRecipe : RecipeFamily
    {
        public SteelSickleRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelSickleRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
