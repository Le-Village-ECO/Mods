...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernAxeRecipe : RecipeFamily
    {
        public ModernAxeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernAxeRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
