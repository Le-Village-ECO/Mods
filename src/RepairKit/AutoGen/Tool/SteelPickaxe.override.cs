...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelPickaxeRecipe : RecipeFamily
    {
        public SteelPickaxeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelPickaxeRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
