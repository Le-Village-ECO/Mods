...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelAxeRecipe : RecipeFamily
    {
        public SteelAxeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelAxeRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
