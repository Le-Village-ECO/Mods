...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronRockDrillRecipe : RecipeFamily
    {
        public IronRockDrillRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronRockDrillRecipe), start: 0.5f, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));
