...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronMacheteRecipe : RecipeFamily
    {
        public IronMacheteRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronMacheteRecipe), start: 0.5f, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));
