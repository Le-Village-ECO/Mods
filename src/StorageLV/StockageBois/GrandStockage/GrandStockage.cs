namespace Eco.Mods.TechTree
{
    ...
    public partial class GrandStockageWoodObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<PublicStorageComponent>().Initialize(14, 5000000);
    ...
    public partial class GrandStockageWoodRecipe : RecipeFamily
    {
        public GrandStockageWoodRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("HewnLog", 30, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(GrandStockageWoodRecipe), start: 0.32f, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));
