...
namespace Village.Eco.Mods.Templates
{
    ...
    [Weight(500)]
    public partial class Shipping_40ftItem : WorldObjectItem<Shipping_40ftObject>
    {
    ...
    #region Recipe
    [Ecopedia("Crafted Objects", "Storage", subPageName: "Stockage Template Item")]
    public partial class Shipping_40ftRecipe : RecipeFamily
    {
        public Shipping_40ftRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Shipping_40ft",  //noloc
                ...
                {
                    new CraftingElement<Shipping_40ftItem>()
                });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stockage Template"), recipeType: typeof(Shipping_40ftRecipe));
            this.ModsPostInitialize();
