namespace Eco.Mods.TechTree
{
    ...
    public partial class BigChariotMineGateObject : WorldObject, IRepresentsItem
    {
        ...
        {
            WorldObject.AddOccupancy<BigChariotMineGateObject>(new List<BlockOccupancy>(){
    ...
    [ForceCreateView]
    [Ecopedia("Decoration", "Décoration de mine", subPageName: "Grande entrée de mine pour chariot")]
    public partial class BigChariotMineGateRecipe : Recipe
    {
        public BigChariotMineGateRecipe()
        {
            ...
            CraftingComponent.AddTagProduct(typeof(CarpentryTableObject), typeof(BigChariotMineGateRecipe), this);
        }
