namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Food", "Milling", subPageName: "Sake Item")]
    public partial class SakeRecipe : RecipeFamily
    {
        public SakeRecipe()
        {
            ...
            recipe.Init(
                name: "Sake",  //noloc
                displayName: Localizer.DoStr("Sake"),

                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(RiceItem), 15, typeof(BakingSkill), typeof(BakingLavishResourcesTalent)),
                    new IngredientElement(typeof(YeastItem), 3)
                },

                items: new List<CraftingElement>
                {
                    new CraftingElement<SakeItem>(1)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SakeRecipe), start: 2, skillType: typeof(MillingSkill), typeof(MillingFocusedSpeedTalent), typeof(MillingParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Baked Corn"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Saké"), recipeType: typeof(SakeRecipe));
