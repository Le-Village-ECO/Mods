...
namespace Eco.EM.Framework.Components
{
    ...
    public class PassiveCraftingComponent : WorldObjectComponent
    {
        ...
        public void Initialize(double passiveCraftTime, Recipe recipe)
        {
            ...
            //foreach (var e in recipe.Items) { prods.Add((e.Item, e.Quantity.GetBaseValue)); }; //LV - Mise à jour code
            foreach (var e in recipe.Products) { prods.Add((e.Item, e.Quantity.GetBaseValue)); }; //LV - Mise à jour code
