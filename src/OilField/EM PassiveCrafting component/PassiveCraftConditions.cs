...
namespace Eco.EM.Framework.Components
{
    ...
    public class PlantAreaCraftCondition : IPassiveCraftCondition
    {
        ...
        private int GetPlantsInArea()
        {
            ...
            //var blocks = WorldUtils.GetTopBlocksInRadius(position, radius);  //LV fix erreur
            var blocks = Utils.WorldUtils.GetTopBlocksInRadius(position, radius);  //LV fix erreur
    ...
    public class RequiredObjectInAreaCraftCondition : IPassiveCraftCondition
    {
        ...
        //private int GetObjectOfTypeInArea() => WorldUtils.GetSurfaceObjectsInRadius(parent.Position3i, radius).Where(obj => obj.GetType() == requiredObjectType).Count();  //LV fix erreur
        private int GetObjectOfTypeInArea() => Utils.WorldUtils.GetSurfaceObjectsInRadius(parent.Position3i, radius).Where(obj => obj.GetType() == requiredObjectType).Count();  //LV fix erreur
        public void OnCraft() { }
    }
    ...
    public class SaturatedObjectInAreaCraftCondition : IPassiveCraftCondition
    {
        ...
        //private int GetObjectOfTypeInArea() => WorldUtils.GetSurfaceObjectsInRadius(parent.Position3i, radius).Where(obj => obj.GetType() == requiredObjectType.GetType()).Count(); //LV fix erreur
        private int GetObjectOfTypeInArea() => Utils.WorldUtils.GetSurfaceObjectsInRadius(parent.Position3i, radius).Where(obj => obj.GetType() == requiredObjectType.GetType()).Count(); //LV fix erreur
        public void OnCraft() { }
    }
