// Le Village - La boite aux lettre tier 2 type pierre
...
namespace Village.Eco.Mods.FacteurMod
{
    ...
    {
        public override LocString DisplayName => Localizer.DoStr("Boite aux Lettres Tier 2 type pierre");
    ...
    public partial class BoiteAuxLettresTier2TypeStoneRecipe : RecipeFamily
    {
        public BoiteAuxLettresTier2TypeStoneRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiteAuxLettresTier2TypeStoneRecipe), start: 8, skillType: typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));
