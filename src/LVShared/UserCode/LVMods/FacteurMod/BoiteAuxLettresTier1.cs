// Le Village - La boite aux lettre Tier 1
    ...
    public partial class BoiteAuxLettresTier1Recipe : RecipeFamily
    {
        public BoiteAuxLettresTier1Recipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Boite aux Lettres Tier1"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiteAuxLettresTier1Recipe), start: 8, skillType: typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Boite aux Lettres"), recipeType: typeof(BoiteAuxLettresTier1Recipe));
            this.ModsPostInitialize();
