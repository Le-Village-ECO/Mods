...
namespace Eco.Mods.TechTree
{
    ...
    public partial class LaboratoryObject : WorldObject, IRepresentsItem
    {
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = LaboratoryItem.homeValue;  //Le village
    ...
    public partial class LaboratoryItem : WorldObjectItem<LaboratoryObject>, IPersistentData
    {
        ...
        //Le village - début ajout
        public override HomeFurnishingValue HomeValue => homeValue;
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue()
        {
            ObjectName = typeof(LaboratoryObject).UILink(),
            Category = HousingConfig.GetRoomCategory("Recherche"),
            BaseValue = 2,
            TypeForRoomLimit = Localizer.DoStr("Poste de recherche"),
            DiminishingReturnMultiplier = 0.5f

        };
        //Le Village - fin ajout
