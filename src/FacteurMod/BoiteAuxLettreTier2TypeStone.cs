...
namespace Village.Eco.Mods.FacteurMod
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Storage", subPageName: " Boite aux lettre Tier 2 en pierre Item")]
    public partial class BoiteAuxLettresTier2TypeStoneObject : WorldObject
    {
        public override LocString DisplayName => Localizer.DoStr(" Boite aux lettre Tier 2 en pierre");
        ...
        static BoiteAuxLettresTier2TypeStoneObject()
        {
            ...
            AddOccupancy<BoiteAuxLettresTier2TypeStoneObject>(BlockOccupancyList);
        }
    ...
    [Serialized]
    [LocDisplayName(" Boite aux lettre Tier 2 en pierre")]
    ...
    public partial class BoiteAuxLettresTier2TypeStoneItem : WorldObjectItem<BoiteAuxLettresObject>
    {
    ...
    public partial class BoiteAuxLettresTier2TypeStoneRecipe : RecipeFamily
    {
        public BoiteAuxLettresTier2TypeStoneRecipe()
        {
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(600, typeof(MasonSkill));
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiteAuxLettresTier2TypeStoneRecipe), start: 10, skillType: typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr(" Boite aux lettre Tier 2 en pierre"), recipeType: typeof(BoiteAuxLettresRecipe));
            this.ModsPostInitialize();

            CraftingComponent.AddRecipe(tableType: typeof(MasonryTableItem), recipe: this);
        }
