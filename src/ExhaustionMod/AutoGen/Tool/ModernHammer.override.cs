...
// Le Village - ExhaustionMod : réduit le coût calorique à 0
...
namespace Eco.Mods.TechTree
{
    ...
    {
        // Static values
        //private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(ModernHammerItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(5, typeof(SelfImprovementSkill), typeof(ModernHammerItem)));  //Le Village
        private static IDynamicValue caloriesBurn = new ConstantValue(0);  //Le Village
