...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelHammerRecipe : RecipeFamily
    {
        public SteelHammerRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelHammerRecipe), start: 0.5f, skillType: typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
    ...
    {
        // Static values
        //private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelHammerItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(6, typeof(SelfImprovementSkill), typeof(SteelHammerItem)));  //Le Village
