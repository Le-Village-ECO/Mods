...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CutMediumAnimal".</para>
    ...
    public partial class CutMediumAnimalRecipe : RecipeFamily
    {
        public CutMediumAnimalRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CutMediumAnimalRecipe), start: 3, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
