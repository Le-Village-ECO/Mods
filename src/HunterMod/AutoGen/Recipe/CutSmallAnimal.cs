...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CutSmallAnimal".</para>
    ...
    public partial class CutSmallAnimalRecipe : RecipeFamily
    {
        public CutSmallAnimalRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CutSmallAnimalRecipe), start: 2, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
